...
dependencies {
    ...
    add(integrationTest.implementationConfigurationName, "org.kodein.di:kodein-di-jvm:7.20.2")
    add(integrationTest.implementationConfigurationName, "org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:1.10.1")
